...
class TrainOptions:
    ...
    def __init__(self):
        ...
        parser.add_argument('--image_root', type=str,
                            default='../dataset/trainsets/trainH_parisstreetview')
        parser.add_argument('--mask_root', type=str,
                            default='../dataset/trainsets/trainmask(256_256)')

        parser.add_argument('--save_dir', type=str, default='snapshots/psv/partial_extractor')
        ...
        parser.add_argument('--gen_lr', type=float, default=0.0002)#default: 0.0002
        ...
        parser.add_argument('--train_iter', type=int, default=700000)
        parser.add_argument('--rec_pretrain_iter', type=int, default=100000)
        ...
        parser.add_argument('--AAI_LOSS', type=float, default=1)
        parser.add_argument('--REC_CODE_LOSS', type=float, default=1.0)
